          ...
          <TabsContent value="overview" className="space-y-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
              <div className="flex flex-col items-center p-4 bg-muted rounded-lg">
                <RulerIcon className="h-5 w-5 mb-2 text-muted-foreground" />
              ...
              <div className="flex flex-col items-center p-4 bg-muted rounded-lg">
                <BedIcon className="h-5 w-5 mb-2 text-muted-foreground" />
              ...
              <div className="flex flex-col items-center p-4 bg-muted rounded-lg">
                <ShowerIcon className="h-5 w-5 mb-2 text-muted-foreground" />
              ...
              <div className="flex flex-col items-center p-4 bg-muted rounded-lg">
                <HomeIcon className="h-5 w-5 mb-2 text-muted-foreground" />
                <span className="text-sm text-muted-foreground">Min Stay</span>
                <span className="font-medium">
            ...
            {hasLeaseConditions && (
              <div>
                <h2 className="text-xl font-semibold mb-3">Lease Conditions</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {listing.leaseConditions.minimumStay && (
                    <div className="flex items-center">
                      <span className="text-muted-foreground w-1/2">
